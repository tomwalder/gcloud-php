...
class SubscriberApi
{
     ...
     *     Optional.
     *     @type PushConfig $pushConfig If push delivery is used with this subscription, this field is
     *           used to configure it. An empty `pushConfig` signifies that the subscriber
     *           will pull and ack messages using API methods.
     *     @type integer $ackDeadlineSeconds This value is the maximum time after a subscriber receives a message
     ...
     * @param integer $ackDeadlineSeconds The new ack deadline with respect to the time this request was sent to
     ...
     * @param integer $maxMessages The maximum number of messages returned for this request. The Pub/Sub
     * system may return fewer than the number specified.
     * @param array $optionalArgs {
     *     Optional.
     *     @type boolean $returnImmediately If this is specified as true the system will respond immediately even if
